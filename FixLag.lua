...
-- Main frame (tăng chiều cao lên để chứa 8 nút)
local Main = Instance.new("Frame")
Main.Size = UDim2.new(0, 270, 0, 465) -- tăng chiều cao để chứa thêm 1 nút
...
local Button8 = createButton("Low GFX-FPS", 8) -- ✅ Thêm nút "Gửi"
...
Button8.MouseButton1Click:Connect(function()
	-- ⚡ Super Optimized Low GFX + FPS Boost Script v2 (Full Effect Remover)
local Players = game:GetService("Players")
local Lighting = game:GetService("Lighting")
...
-- ❌ Tắt hiệu ứng ánh sáng nâng cao
for _, v in pairs(Lighting:GetChildren()) do
    if v:IsA("PostEffect") or v:IsA("BlurEffect") or v:IsA("SunRaysEffect")
        or v:IsA("ColorCorrectionEffect") or v:IsA("BloomEffect") then
        v.Enabled = false
    end
end
...
-- 🔥 Xoá và tắt tất cả hiệu ứng không cần thiết
local function removeEffects(obj)
    for _, v in ipairs(obj:GetDescendants()) do
        if v:IsA("ParticleEmitter") or v:IsA("Trail") or v:IsA("Beam")
        or v:IsA("Fire") or v:IsA("Smoke") or v:IsA("Sparkles")
        or v:IsA("Explosion") or v:IsA("Highlight") or v:IsA("SelectionBox")
        or v:IsA("PointLight") or v:IsA("SurfaceLight") or v:IsA("SpotLight")
        or v:IsA("ForceField") then
            v:Destroy()
        elseif v:IsA("Decal") or v:IsA("Texture") then
            v:Destroy()
...
-- 📡 Lắng nghe khi có object mới được thêm vào
Workspace.DescendantAdded:Connect(function(obj)
    if obj:IsA("ParticleEmitter") or obj:IsA("Trail") or obj:IsA("Beam")
    or obj:IsA("Fire") or obj:IsA("Smoke") or obj:IsA("Sparkles")
    or obj:IsA("Explosion") or obj:IsA("Highlight") or obj:IsA("SelectionBox")
    or obj:IsA("PointLight") or obj:IsA("SurfaceLight") or obj:IsA("SpotLight")
...
-- 🧠 Giảm chất lượng đồ hoạ nếu có thể
pcall(function()
...
print("✅ Full GFX Clean + FPS Boost Activated!")
end)